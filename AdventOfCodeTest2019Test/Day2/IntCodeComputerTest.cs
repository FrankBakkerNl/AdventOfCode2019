...
namespace AdventOfCodeTest2019Test.Day2
{
    ...
    public class IntCodeComputerTest
    {
        ...
        public void SelfTest()
        {
            ...
            computer.Run();
            var output = computer.Output.AsIEnumerableAsync().Result.ToArray();
            output[..^1].Should().AllBeEquivalentTo(BigInteger.Zero);
        }

                [Fact]
        public void BlockedOnInputTest()
        {
            var program = "3,1000,4,1000,99";;
            var computer = new IntCodeComputer(program);
            Action run = ()=>
            {
                computer.Run();
