...
7 A, 1 E => 1 FUEL";
            ...
            var result = Day14.CreateLookup(input);
            var formula = result["C"];
            
            formula.quantity.Should().Be(1);
            formula.inputs.Should().BeEquivalentTo((7, "A"), (1, "B"));
        }

        [Fact]
        public void GetOreRequiredforOneFuelTest()
        {
            var input = @"10 ORE => 10 A
1 ORE => 1 B
7 A, 1 B => 1 C
...
7 A, 1 E => 1 FUEL";
        ...
        [Fact]
        public void GetOreRequiredforOneFuelTest_2()
        {
